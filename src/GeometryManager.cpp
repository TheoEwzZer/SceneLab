...
void GeometryManager::initGeometryWindow(std::function<void()> onObjectCreated)
{
    m_geometryWindow.onSpawnCube = [this, onObjectCreated](float size) {
        ...
        new_obj.setName(
            std::format("Cube {}", m_geometryWindow.m_cubeCount));
    ...
    m_geometryWindow.onSpawnSphere = [this, onObjectCreated](float radius, int sectors,
                                              int stacks) {
        GameObject new_obj;
    ...
    m_geometryWindow.onSpawnCylinder = [this, onObjectCreated](float radius, float height,
                                                int sectors) {
        GameObject new_obj;
    ...
    m_geometryWindow.onLoadModel = [this](const std::string& objName,
    ...
    m_geometryWindow.onSpawnModelInstance =
        [this, onObjectCreated](const std::string& name, const std::string& filepath) {
